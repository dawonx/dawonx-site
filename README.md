...
The header and footer use a custom geometric SVG wordmark. It rests as DX; hover or keyboard focus moves X outward and reveals AWON with a brief glitch. Its reserved width keeps navigation still, and reduced-motion preferences remove the transition and glitch. Touch users retain a direct home link.
